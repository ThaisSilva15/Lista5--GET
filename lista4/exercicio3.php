	    ...
	    <input type="password" name="senha" placeholder="Nova Senha">  	
           ...
           <select>
            ...
            <a href="#">Por que preciso informar minha data de nascimento?</a><br>
                <br><input id="femi" type="radio" name="senha">  <label for="femi"> Feminino </label>
                <input id="masc" type="radio" name="senha">  <label for="masc"> Masculino </label>

                <p>Ao clicar em Inscreva-se, você concorda com nossosa <a href="#"> Termos</a>, <a href="#"> Politica de Dados </a> e <a href="#"> Politica de Cookies. </a>
